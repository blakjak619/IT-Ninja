...
Configuration CMCSecurityConfigTLU
{
...
#region IIS
        File CMCSecurityServiceDir
        {
            ...
            Ensure = "Present"
            Type = "Directory"
            SourcePath = "\\10.13.0.206\scratch\DML\CampusVue\SecurityServer\CampusVue Security Server\CampusVue_Security_Server_Standup\Source-TLU"
            Credential = $Credential
