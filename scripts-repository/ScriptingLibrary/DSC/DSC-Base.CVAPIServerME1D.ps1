...
#region WindowsFeature
      ...
      Package CrystalReports
	  {
		  ...
		  Path = "C:\Temp\CVStandUp\CrystalReports\Crystal Archive\Archive\CRRuntime_12_2_mlb.msi"
		  ProductID = "C484CC8D-03CF-4022-89C4-DB4F02E8A15B"
		  Ensure = "Present"
          Arguments = "/passive /norestart"
      }
