...
/****** Object:  StoredProcedure [dbo].[dba_CopyLogins]    Script Date: 04/04/2012 10:40:54 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[dba_CopyLogins]') AND type in (N'P', N'PC'))
